              ...
              <form onSubmit={handlePublishSubmit} className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row justify-between sm:items-center border-b border-slate-100 pb-6 gap-4">
                  <div className="flex items-center gap-3.5">
                    ...
                    <div>
                      <h3 className="font-extrabold text-base text-slate-900">Platform Admin</h3>
                ...
                <div className="flex justify-end pt-4 border-t border-slate-100">
                  <button
                    ...
                    className={`font-bold py-3.5 px-8 rounded-2xl shadow-lg shadow-blue-600/20 transition-all border-none text-sm flex items-center gap-2 ${isPublishing ? 'bg-slate-400 text-white cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700 text-white active:scale-95 cursor-pointer'}`}
                  >
                    {isPublishing ? <FaSpinner className="animate-spin" /> : <FaPaperPlane />}
                    {isPublishing ? 'Publishing...' : updateType === 'post' ? 'Publish to Community Feed' : 'Publish 24h Story'}
                  </button>
                </div>
...
export default AdminCreateUpdatePage;
