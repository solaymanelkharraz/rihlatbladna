...
const AdminPostsPage = () => {
  ...
  const myPosts = (posts || []).filter(p => p.agencyId === user?.id || p.agencyRole === 'admin');
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
            <div>
              <h1 className="text-3xl font-black text-slate-900 tracking-tight flex items-center gap-2.5">
                <FaBullhorn className="text-blue-600" /> Platform Announcements
              </h1>
              <p className="text-slate-500 text-sm mt-1">Manage official platform announcements and stories visible to all users.</p>
            </div>
            <Link
              to="/admin/story"
          ...
          <div className="space-y-8">
            {myPosts.length > 0 ? (
              ...
              <div className="bg-white rounded-[2.5rem] p-12 text-center border border-slate-100 shadow-sm">
                ...
                <h3 className="text-lg font-bold text-slate-800 mb-1">No Announcements Published Yet</h3>
                <p className="text-slate-400 text-sm max-w-md mx-auto mb-6">Create your first official platform announcement or 24-hour story.</p>
                <Link
                  to="/admin/story"
