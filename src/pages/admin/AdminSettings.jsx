...
const AdminSettings = () => {
  ...
  const handleSaveProfile = async () => {
    ...
    if (res.success) {
      ...
      showAlert("Error", res.message || "Failed to update profile", "error");
    }
    setIsSaving(false);
  };
            ...
            <div className="space-y-6">
              ...
              <div className="pt-6 border-t border-slate-100 flex justify-end">
                <button 
                  ...
                  disabled={isSaving}
                  className={`font-bold py-3.5 px-10 rounded-2xl shadow-lg shadow-amber-500/20 active:scale-95 transition-all text-sm flex items-center gap-2 border-none cursor-pointer ${isSaving ? 'bg-slate-400 text-white cursor-not-allowed' : 'bg-amber-500 hover:bg-amber-600 text-white'}`}
                >
